...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("1)구매 2)장바구니 3)관리자메뉴");
			...
			if(work.equals("1") || work.equals("구매")) {
				...
				System.out.println("메뉴)) 품목선택 ( 99번 입력시 뒤로가기");
				while(true) {
					try {
			...
			else if(work.equals("2") || work.equals("장바구니")) {
				
			}
			else if(work.equals("3") || work.equals("관리자") || work.equals("관리자메뉴")) {
