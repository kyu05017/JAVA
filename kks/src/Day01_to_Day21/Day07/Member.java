...
public class Member {
	...
	String login() {//로그인 성공하면 성공한 아이디 반환 실패시 null를 반환
		...
		String id = Day07_5_bookApplication.scanner.next();
		System.out.println("비밀번호를입력하세요");
		String pw = Day07_5_bookApplication.scanner.next();
	...
	void findid() {
		...
		String inputname = Day07_5_bookApplication.scanner.next();
		System.out.println("전화번호를 입력하세요.");
		String inputphone = Day07_5_bookApplication.scanner.next();
		boolean ck = false;
		int i = 0;
		for(Member temp : Day07_5_bookApplication.members) {
	...
	void findpw() {
		System.out.println("---------------아이디찾기---------------");
		System.out.println("아이디를 입력하세요.");
		String inputid = Day07_5_bookApplication.scanner.next();
		System.out.println("전화번호를 입력하세요.");
		String inputphone = Day07_5_bookApplication.scanner.next();
		boolean ck = false;
		int i = 0;
