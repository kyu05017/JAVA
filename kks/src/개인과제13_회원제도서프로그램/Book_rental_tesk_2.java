...
public class Book_rental_tesk_2 {
	...
	public Book_rental_tesk_2() {
		
	}
	
	public Book_rental_tesk_2(String iSBN, String book_Name, String book_Writer, boolean book_rent, String member_id) {
		this.ISBN = iSBN;
	...
	int Book_add(String ISBN, String name, String writer) {
		...
		Book_rental_tesk_2 book = new Book_rental_tesk_2(ISBN, name, writer,true , " ");
		
		
		for(Book_rental_tesk_2 temp : Main_2.booklist) {
