...
public class Main_4 {
	...
	static Member_tesk_4[] memberlist = new Member_tesk_4[1000];
	static Book_rental_tesk_4[] booklist = new Book_rental_tesk_4[1000]; 
	static Main_4 main = new Main_4();
	...
	void Menu() {
		Member_tesk_4 member = new Member_tesk_4();
		while(true) {
	...
	void MemberMenu(String id) {
		...
		while(true) {
			...
			int ch= sc.nextInt();
			Book_rental_tesk_4 book = new Book_rental_tesk_4();
