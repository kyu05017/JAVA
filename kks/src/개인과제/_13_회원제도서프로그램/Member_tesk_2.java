...
public class Member_tesk_2 {
	...
	public Member_tesk_2() {

	}

	public Member_tesk_2(int member_Number, String id, String password, String name, String phone) {
	...
	int registration(String id, String password, String name, String phone) {
		...
		for(Member_tesk_2 temp : Main_2.memberlist) {
		...
		for(Member_tesk_2 temp : Main_2.memberlist) {
			if(temp == null) {
				if(i == 0) {
					...
					num = Main_2.memberlist[i-1].member_Number + 1;
					break;
				}
			}
			i++;
		...
		Member_tesk_2 account = new Member_tesk_2(num, id, password, name, phone);
		
		int j = 0;
		for(Member_tesk_2 temp : Main_2.memberlist) {
			if(temp == null) {
				Main_2.memberlist[i] = account;
				return 1;
			}
		}
		return 0;
