...
public class Main_2 {
	...
	static Member_tesk_2[] memberlist = new Member_tesk_2[1000];
	static Book_rental_tesk_2[] booklist = new Book_rental_tesk_2[1000]; 
	static Main_2 main = new Main_2();
	...
	void Menu() {
		Member_tesk_2 member = new Member_tesk_2();
		while(true) {
	...
	void MemberMenu(String id) {
		...
		while(true) {
			...
			int ch= sc.nextInt();
			Book_rental_tesk_2 book = new Book_rental_tesk_2();
