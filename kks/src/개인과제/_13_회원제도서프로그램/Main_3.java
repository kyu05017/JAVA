...
public class Main_3 {
	...
	static Member_tesk_3[] memberlist = new Member_tesk_3[1000];
	static Book_rental_tesk_3[] booklist = new Book_rental_tesk_3[1000]; 
	static Main_3 main = new Main_3();
	...
	void Menu() {
		Member_tesk_3 member = new Member_tesk_3();
		while(true) {
	...
	void MemberMenu(String id) {
		...
		while(true) {
			...
			int ch= sc.nextInt();
			Book_rental_tesk_3 book = new Book_rental_tesk_3();
