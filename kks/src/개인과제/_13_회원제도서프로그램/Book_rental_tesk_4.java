...
public class Book_rental_tesk_4 {
	...
	public Book_rental_tesk_4() {
		
	}
	
	public Book_rental_tesk_4(String iSBN, String book_Name, String book_Writer, boolean book_rent, String member_id) {
		this.ISBN = iSBN;
	...
	int Book_add(String ISBN, String name, String writer) {
		...
		Book_rental_tesk_4 book = new Book_rental_tesk_4(ISBN, name, writer,true , " ");
		
		
		for(Book_rental_tesk_4 temp : Main_4.booklist) {
	...
	int Book_Rent(String id, String ISBN) {
		...
		for(Book_rental_tesk_4 temp : Main_4.booklist) {
			if(temp != null && temp.ISBN.equals(ISBN)){
				if(temp.book_rent) {
					Main_4.booklist[i].book_rent = false;
					Main_4.booklist[i].member_id = id;
					return 1;
				}
				else {
					return 5;
		...
		for(Book_rental_tesk_4 temp : Main_4.booklist) {
			if(temp != null && temp.ISBN.equals(ISBN)){
				if(temp.book_rent) {
					...
					Main_4.booklist[i].book_rent = true;
					Main_4.booklist[i].member_id = " ";
					return 1;
				}
			}
			i++;
