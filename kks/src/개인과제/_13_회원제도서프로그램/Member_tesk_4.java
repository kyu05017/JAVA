...
public class Member_tesk_4 {
	...
	public Member_tesk_4() {

	}

	public Member_tesk_4(int member_Number, String id, String password, String name, String phone) {
	...
	int registration(String id, String password, String name, String phone) {
		...
		for(Member_tesk_4 temp : Main_4.memberlist) {
		...
		for(Member_tesk_4 temp : Main_4.memberlist) {
			if(temp == null) {
				if(i == 0) {
					...
					num = Main_4.memberlist[i-1].member_Number + 1;
					break;
				}
			}
			i++;
		...
		Member_tesk_4 account = new Member_tesk_4(num, id, password, name, phone);
		
		int j = 0;
		for(Member_tesk_4 temp : Main_4.memberlist) {
			if(temp == null) {
				Main_4.memberlist[i] = account;
				return 1;
			}
		}
		return 0;
